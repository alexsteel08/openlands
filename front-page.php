...
<div class="content">
    ...
    <section class="green_phone">
        <div class="green_phone_block">
            <div class="green_phone_content">

                <?php if( get_field('gp_left_image') && get_field('gp_left_title') && get_field('gp_left_link') ): ?>
                    <div class="green_phone_left" data-aos="fade-right" data-aos-delay="100">
                           <div class="gp_left">
                               <a href="<?php the_field('gp_left_link'); ?>">
                ...
                <div class="green_phone_center">
                    <div class="gp_center">
                        <?php if( get_field('gp_center_image') ): ?>
                           <div class="gp_center_img">
                               <img data-aos="fade-up" data-aos-delay="100" src="<?php the_field('gp_center_image'); ?>" alt="img">
                           </div>
                        <?php endif; ?>
                        <?php if( have_rows('gp_center_list') ): ?>
                            <div class="gp_center_list">
                                <?php while( have_rows('gp_center_list') ): the_row(); ?>
                                    <div class="gp_center_item" data-aos="fade-right" data-aos-delay="<?php echo get_row_index(); ?>00">
                ...
                <?php if( get_field('gp_right_image') && get_field('gp_right_title') && get_field('gp_right_link')): ?>
                    <div class="green_phone_right" data-aos="fade-left" data-aos-delay="100">
                        <div class="gp_right">
                            <a href="<?php the_field('gp_right_link'); ?>">
                    ...
                    <?php if( have_rows('landejer_app_list') ): ?>
                        <div class="landejer_app_list">
                            <?php while( have_rows('landejer_app_list') ): the_row(); ?>
                                <div class="landejer_app_item" data-aos="fade-right" data-aos-delay="<?php echo get_row_index(); ?>00">
                    ...
                    <?php if( have_rows('hunter_list') ): ?>
                        <div class="hunter_list">
                            <?php while( have_rows('hunter_list') ): the_row(); ?>
                                <div class="hunter_list_item" data-aos="fade-left" data-aos-delay="<?php echo get_row_index(); ?>00">
                    ...
                    <div class="hunter_app">
                        ...
                        <?php if( get_field('hunter_screan') ): ?>
                           <div class="hunter_screan">
                               <img data-aos="fade-right" data-aos-delay="100" src="<?php the_field('hunter_screan'); ?>" alt="img">
                           </div>
                        <?php endif; ?>
                    </div>
                </div>
